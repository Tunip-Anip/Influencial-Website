...
* Needs to produce 2 or more colours to create a palette
## Non-Functional Requirements
* Can have a custom creator mode to make palettes
* Can Share your palettes
...
From this graph it supports the website slightly more as some people find themselves in situations where they need colour to choose a colour. This would benefit the cause of the colour palette generator and help it gain traction to grow further. This sustains the audience of the website and proves that it may be a capable website in the future.
...
## Prototype
<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/proto/owfKPKjFnFGNWOaN9Rt7pg/CTPrototype?node-id=4008-1223&p=f&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=4008%3A1223&embed-host=share" allowfullscreen></iframe>
...
## Week 3 Evaluation:
A lot of progress was made this week. Firstly I made a group of buttons in a div which are all affected by an onclick function, this was done in a very roundabout and low skill way with a mass of nested '<divs>' but it works nevertheless. I also connected the sliderbar that was made in week one to the amount of buttons shown on the screen with the 'display' aspect in css which allows for further control of the palette. Further styling was also done where I centred both the slider and the slider amount display. I also gave the navigation button symbols to provide a cleaner look to the nav bar at the top and I styled the login page.
...
```
Whenever any part of the area is clicked all the buttons need to individually randomise their colour, example with:
...
### HRML
```
    <td>{{ post.author.username }} says:<br>
                    <button id="Star8" style="height: 7vw; width: 7vw; background-color: rgb(136, 176, 251);">
                    </button>
                    <button id="Star7" style="height: 7vw; width: 7vw; background-color: rgb(9, 51, 74);">
                    </button>
                    <button id="Star6" style="height: 7vw; width: 7vw; background-color: rgb(0, 0, 0);">
                    </button>
                    <button id="Star5" style="height: 7vw; width: 7vw; background-color: rgb(81, 118, 110);">
                    </button>
                    <button id="Star4" style="height: 7vw; width: 7vw; background-color: white;">
                    </button></td>
        </tr>
        ...
        <a href="{{ url_for('login') }}"><img src="{{ url_for('static', filename='icons/Login.png') }}" alt="" class="home" style="width: 3%;"></a>
                    ...
                    Star Palette Hexcodes eg ('e0e0e0,a1a1a1, ...')<br>
            {{ form.starP(cols=50, rows=4) }}<br>
            ...
            <input type="color" class="colpic" id="colpic1">


```


### HTML block for the Starred Palette:
```
 <h1>User: {{ user.username }}</h1>
            ...
            <td>
                <div onload="disStar()" class="starp">
                    <script>
                        function disStar(){
                            var mainStr = "{{ user.starP }}"
                            console.log(mainStr)
                            var color0 = '#' + mainStr.substr(0, 6)
                            var color1 = '#' + mainStr.substr(7, 6)
                            var color2 = '#' + mainStr.substr(14, 6)
                            var color3 = '#' + mainStr.substr(21, 6)
                            var color4 = '#' + mainStr.substr(28, 6)
                            var color5 = '#' + mainStr.substr(35, 6)
                            var color6 = '#' + mainStr.substr(42, 6)                            
                            var color7 = '#' + mainStr.substr(49, 6)
                            var color8 = '#' + mainStr.substr(56, 6)
                               
                           
                            var amountS = (mainStr.split(",").length - 1) + 1
                            var amountP = 9 - amountS
                            for(let e = 0; e < amountP; e++){
                            ...
                            document.getElementById("Star0").style.backgroundColor = color8
                            document.getElementById("Star1").style.backgroundColor = color7
                            document.getElementById("Star2").style.backgroundColor = color6
                            document.getElementById("Star3").style.backgroundColor = color5
                            document.getElementById("Star4").style.backgroundColor = color4
                            document.getElementById("Star5").style.backgroundColor = color3
                            document.getElementById("Star6").style.backgroundColor = color2
                            document.getElementById("Star7").style.backgroundColor = color1
                            document.getElementById("Star8").style.backgroundColor = color0
                    ...
                    <button id="Star8" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
                    <button id="Star7" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
                    <button id="Star6" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
                    <button id="Star5" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
                    <button id="Star4" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
                    <button id="Star3" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
                    <button id="Star2" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
                    <button id="Star1" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
                    <button id="Star0" style="height: 7vw; width: 7vw; background-color: white;">
                    </button>
